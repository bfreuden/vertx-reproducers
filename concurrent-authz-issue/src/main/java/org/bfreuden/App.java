    ...
    public static void main( String[] args ) throws InterruptedException {
        ...
        VERTX.deployVerticle(
                ...
                new DeploymentOptions()
                        .setInstances(EVENT_LOOP_THREADS)
                        .setConfig(new JsonObject().put("useAsyncLock", args.length != 0 && args[0].equals("useAsyncLock")))
        ).onComplete(v -> countDownLatch.countDown());
